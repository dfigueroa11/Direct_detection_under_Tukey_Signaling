...
class Detector_block:
    ...
    def set_representative_class(self,representative_class):
        ...
        self.__vars_y__ = ((1-self.beta)*self.symbol_time)**2*(self.alpha2*power_x*self.sigma2_sh+self.sigma2_th)
        ...
        self.__vars_z__ = (self.beta*self.symbol_time)**2*(self.alpha2*phi*self.sigma2_sh+self.sigma2_th)
